 ...
 * @since 2020/4/2
 */
public class ReplayingDecoderByteBufEx extends ByteBuf {

    private static final Signal REPLAY = ReplayingDecoderEx.REPLAY;

    private ByteBuf buffer;
    private boolean terminated;
    private SwappedByteBuf swapped;

    static final ReplayingDecoderByteBufEx EMPTY_BUFFER = new ReplayingDecoderByteBufEx(Unpooled.EMPTY_BUFFER);

    static {
        EMPTY_BUFFER.terminate();
    }

    ReplayingDecoderByteBufEx() { }

    ReplayingDecoderByteBufEx(ByteBuf buffer) {
